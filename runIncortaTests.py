...
# log_wd_path = Auto_Module.output.create_log_folder(wd_path)
# # # Create MAIN Log
...
# detailed_log_path = wd_path + os.sep +"sample.log"
    ...
    for names in temp_dir:
        if 'datafiles' == names:
            ...
            for dir in test_suite_subdirectories:  # For loop for each test case inside test suite
                ...
                test_case_name_dict[dir] = Auto_Module.output.generate_suc_dif_file_names(Data_Validation_Path, dir)
...
# XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
        ...
        #     Auto_Module.data_upload.schema_load_validatior(schema_list, full_schema_export_list, Loader_Validation_Path)
    test_suite_name_temp = sub_dir
    print test_suite_name_temp

print "------------------------------------------Summary------------------------------------------------------"
print "TEST SUITES"
print test_suite_name_dict.keys()
print "TEST SUITE DICTIONARY"
print test_suite_name_dict
print "Printing test cases"
print test_case_name_dict.values()
print "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
print "PRINTING TEST CASES DICTIONARY"
print test_case_name_dict
print "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"