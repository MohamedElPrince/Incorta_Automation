...
def main():
    ...
    parser = argparse.ArgumentParser(description='Description for Custom LogParser', formatter_class=argparse.RawTextHelpFormatter)
    parser.add_argument('-f', '--file', help='Logfile to be Parsed. \nSample Input: /home/incorta/incorta.2017.log', required=True)
