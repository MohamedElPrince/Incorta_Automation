...
public class AllContent_DashboardPagination {
	...
	public void verifyPaginationUiExists() {
		...
		mainPage.SearchForContentAndOpenResult(
				testDataReader.getCellData("Automation_Pivot_PaginationDashboard_PageSize20"));

		dashboardPage = new AllContent_Dashboard(driver);
		dashboardPage
				.assert_dashboardName(testDataReader.getCellData("Automation_Pivot_PaginationDashboard_PageSize20"));
	...
	// Prerequisite: Dashboard [Automation_Pivot_Pagination_Dashboard] created +
	// Insight with pagination created [Automation_Insight] + pagination on page
	...
	// Prerequisite: Dashboard [Automation_Pivot_Pagination_Dashboard] created +
	// Insight with pagination created [Automation_Insight] + Update page size to be
	// 5
	...
	// Prerequisite: Dashboard [Automation_Pagination_Dashboard_PageSize] created
	// without changing page size in it + Insight with pagination created
	// [Automation_Insight]
	// Pagination_Assert_PageSize function is not working which causing next TC to
	// fail
	...
	public void assert_Pagination_PageSizeIs1000ByDefault() {
		...
		mainPage = new Skeleton(driver);
		mainPage.SearchForContentAndOpenResult(
				testDataReader.getCellData("Automation_Pivot_PaginationDashboard_DefaultPageSize"));
		dashboardPage = new AllContent_Dashboard(driver);
	...
	public void assert_Pagination_PageSize_DoNotAccept_NonPositiveIntegerValue() {
		...
		dashboardPage.Pagination_Assert_PageSizeNotEquelToNumberOfRowsInTable(
				testDataReader.getCellData("NonPositiveIntegerPageSize"));
	}
