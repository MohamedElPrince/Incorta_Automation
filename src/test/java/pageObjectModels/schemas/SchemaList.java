...
public class SchemaList {
    ...
    private String url = System.getProperty("incortaRoot") + testDataReader.getCellData("URL_schemas_schemaList");
    private String popup_schema_schedule_Error_Message = replace_regularExpression(
	    "INC_004010050:Another SCHEDULER with the same name [Automation_ScheduleSchema_Load] already exists.");
    //// Elements
    private By header_schemaListTabHeader_link = By
	    .xpath("//*[@id='content']//div[contains(@class,'secHeaderTitle')]//a[normalize-space(.)='Schemas']");
    private By body_schemaName_link;
    private By body_schemaDetails_button;
    private By body_OwnerName_link;
    private By body_iframe = By.xpath("//iframe[@title='Legacy Web']");

    private By popup_scheduleSchema_header = By
	    .xpath("//span[contains(@class,'ng-scope')][text()='Schedule Schema Load']");
    private By popup_scheduleSchema_view = By.id("send-dashboard-modal");
    private By popup_scheduleSchema_label;
    private By popup_scheduleSchema_label_textBox;
    private By popup_scheduleSchema_JobName_textBox = By.xpath("//input[contains(@placeholder,'Job Name')]");
    private By popup_scheduleSchema_button = By.xpath("//button[@type='button'][contains(text(),'Schedule')]");
    private By popup_scheduleSchema_button_disabled = By
	    .xpath("//button[@type='button'][@disabled='disabled'][contains(text(),'Schedule')]");
    private By popup_scheduleSchema_errorMessageBody_label = By
	    .xpath("//div[contains(@class,'text-center')]/child::div[@class='ng-binding']");
    private By popup_scheduleSchema_radioButton;
    ...
    private By popup_scheduleSchema_dailyRecurrence_minute = By
    ...
    private By popup_newSchema_schemaName_textBox = By.xpath("//input[@ng-model='$parent.schemaName']");
    private By popup_newSchema_schemaDescription_textBox = By
	    .xpath("//textarea[@ng-model='$parent.schemaDescription']");
    private By popup_newSchema_create_button = By.xpath("//button[@type='submit'][contains(text(),'Create')]");
