...
public class Users {
    ...
    private String url = System.getProperty("incortaRoot") + testDataReader.getCellData("URL_security_users");
    private String imagesFolderPath = System.getProperty("testDataFolderPath") + "images/";

    //// Elements
    private By body_name_checkbox;
    private By body_name_link;
    private By body_image_icon;
    private By body_iframe = By.xpath("//iframe[@title='Legacy Web']");

    private By popup_addNewUser_loginName_textBox = By.xpath("//input[@ng-model='user.loginName']");
    private By popup_addNewUser_password_textBox = By.xpath("//input[@ng-model='user.password']");
    private By popup_addNewUser_confirmPassword_textBox = By.xpath("//input[@ng-model='user.password_verify']");
    private By popup_addNewUser_displayName_textBox = By.xpath("//input[@ng-model='user.name']");
    private By popup_addNewUser_email_textBox = By.xpath("//input[@ng-model='user.email']");
    private By popup_addNewUser_language_list = By.xpath("//select[@ng-model='user.language']");
    private By popup_addNewUser_regionFormat_list = By.xpath("//select[@ng-model='user.country']");
    private By popup_addNewUser_timeZone_list = By.xpath("//select[@ng-model='user.timezone']");
    private By popup_addNewUser_calendar_list = By.xpath("//select[@ng-model='user.calendar']");
    private By popup_addNewUser_uploadImage_textBox = By
	    .xpath("//div[contains(@class,'userDetailsModal')]//input[@type='file']");
    private By popup_addNewUser_addUser_button = By.xpath("//button[@ng-click='addNewUser(user)']");
    private By popup_existingUser_saveChanges_button = By.xpath("//button[@ng-click='updateUser(user)']");

    private By popup_confirmDelete_transferOwnership_button = By
	    .xpath("//div[contains(@class,'confirmDeleteModal')]//button[normalize-space()='Transfer ownership']");
    private By popup_confirmDelete_deleteAnyway_button = By
	    .xpath("//div[contains(@class,'confirmDeleteModal')]//button[normalize-space()='Delete anyway']");

    private By popup_confirmDelete_delete_button = By
	    .xpath("//div[contains(@class,'confirmDeleteModal')]//button[normalize-space()='Delete']");

    private By popup_transferOwnership_targetuser_radioButton;
    // p[contains(normalize-space(),'Transfer ownership to the current
    // user')]/preceding-sibling::input[@type='radio']
    private By popup_transferOwnership_transferSharingPermissions_checkBox = By
	    .xpath("//input[@type='checkbox'][@ng-model='transferSharingPermissions']");
    private By popup_transferOwnership_transferOwnership_button = By.xpath("//button[@ng-click='transferOwnership()']");

    private By popup_userInformation_userDetails_LoginAsUser_button = By.xpath("//a[@ng-click='impersonate(user)']");

    private By popup_UsersToBeAdded_checkbox;
    private By popup_addUsersToGroup_UsersPage_add_button = By
	    .xpath("//div[contains(@class,'userDetailsModal')]//button[@type='submit'][normalize-space(.)='Add']");

    private By popup_Transfer_Ownership_To_AnotherUser_Searchbox = By.xpath("//input[@ng-model='entitySearchText']");
    private By popup_Transfer_Ownership_To_AnotherUser_SearchList;
	...
	////////////////////////
	popup_Transfer_Ownership_To_AnotherUser_SearchList = By
