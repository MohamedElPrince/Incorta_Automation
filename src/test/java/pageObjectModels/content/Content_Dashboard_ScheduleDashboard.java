...
public class Content_Dashboard_ScheduleDashboard {
    ...
    // Schedule Dashboard
    private By body_scheduleDashboard_jobNameField = By.id("jobName");

    private By body_scheduleDashboard_startingPicker_timeZone_clickOnDropdownMenu = By
	    .xpath("//div[contains(@class,'starting-picker')]//div[@role='combobox']");
    private By body_scheduleDashboard_startingPicker_timeZone_selectTimeZone;
    private By body_scheduleDashboard_startingAtTimeExternal_textBox = By
	    .xpath("//input[@class='ant-time-picker-input']");
    private By body_scheduleDashboard_startingAtTimeInternal_textBox = By
	    .xpath("//input[contains(@class,'ant-time-picker-panel-input')]");

    private By body_scheduleDashboard_startingPicker_dayOfTheMonth = By
	    .xpath("//div[@class='input-group months-picker']//div[@role='combobox']");
    private By body_scheduleDashboard_startingPicker_dayOfTheMonth_number = By
	    .xpath("//div[@class='input-group months-picker']//input[contains(@class,'input-number')]");
    private By body_scheduleDashboard_startingPicker_dayOfTheMonth_specificday = By.xpath(
	    "//div[@class='input-group-inputs months-picker-inputs']//div[@class='ant-select-selection-selected-value'][contains(.,'1st')]");

    private By body_scheduleDashboard_startingPicker_days;

    private By body_scheduleDashboard_everyPicker_selectNoRecurrence = By
	    .xpath("//label[contains(@class,'no-recurrence ')]//input[@type='checkbox']");
    private By body_scheduleDashboard_everyPicker_number = By.xpath("//input[@class='ant-input-number-input']");
    private By body_scheduleDashboard_everyPicker_recurrence_clickOnDropDown = By
	    .xpath("//div[contains(@class,'select-recurrence')]//span");

    private By body_scheduleDashboard_datePicker_calanderFrom = By
	    .xpath("(//div[contains(@class,'date-pickers-inputs')]//input[@placeholder='Select date'])[1]");
    private By selectDate = By.xpath("//input[@class='ant-calendar-input ']");
     ...
     * 
     * @param Time
     *            Should have the format of "12:00 PM" Or "12:00 AM"
     * 
     */
	...
	ElementActions.typeAppend(driver, body_scheduleDashboard_startingAtTimeInternal_textBox,
		timeValue.substring(0, timeValue.indexOf('M')));
	...
	// .xpath("//div[@class='ant-time-picker-panel-select'][1]//li[contains(string(),'"
	// + Hour + "')]");
	// body_scheduleDashboard_startingPicker_time_minute = By
	// .xpath("//div[@class='ant-time-picker-panel-select'][2]//li[contains(string(),'"
	// + Minute + "')]");
	// body_scheduleDashboard_startingPicker_time_AmPm = By
	// .xpath("//div[@class='ant-time-picker-panel-select'][3]//li[contains(string(),'"
	// + AmPm + "')]");

	// ElementActions.click(driver, body_scheduleDashboard_startingPicker_time);

	// ElementActions.click(driver,
	// body_scheduleDashboard_startingPicker_time_hour);
	// ElementActions.click(driver,
	// body_scheduleDashboard_startingPicker_time_minute);
	...
	// try {
	// ElementActions.click(driver,
	// body_scheduleDashboard_startingPicker_time_AmPm);
	// } catch (AssertionError e) {
	// ElementActions.click(driver,
	// body_scheduleDashboard_startingPicker_time_AmPm);
	// }
