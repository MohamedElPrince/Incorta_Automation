...
public class Content_Dashboard_AnalyzeInsight {
    //// Variables
    private WebDriver driver;

    //// Elements
    private By menuHeader_search_textBox = By
	    .xpath("//tables-panel//input[@ng-model='$ctrl.searchKey'][not(ancestor::tables-selection-panel)]");
    private By menuHeader_add_button = By.xpath("//a[contains(@ng-click,'openSelection()')]");
    private By menuBody_element_label;
    private By menuBody_addElement_button;

    private By submenuHeader_viewOrTable_list = By.id("viewDropdown");
    private By submenuHeader_viewOrTableListOption_link; // a[@role='menuitem'][normalize-space()='Views']
    private By submenuHeader_search_textBox = By.xpath("//tables-selection-panel//input[@ng-model='$ctrl.searchKey']");
    private By submenuBody_element_checkBox;
    private By submenuBody_done_button = By.className("done-button");
    private By popup_submenuHeader_addInsight_button = By.xpath("//i[@class='anticon anticon-plus']");

    private By body_insightName_textBox = By.xpath("//input[@ng-model='component.title']");
    private By body_iframe = By.xpath("//iframe[@title='Legacy Web']");

    private By popup_chooseAVisualization_visualizationType_text;

    private By body_insightNameField;

    //// Functions
    public Content_Dashboard_AnalyzeInsight(WebDriver driver) {
	this.driver = driver;
    }
