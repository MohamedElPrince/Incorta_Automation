...
public class NewUI_Content_Dashboard {
	...
	public String scheduleDashboard_addFields_clickScheduleDashboard(String JobName, String subjectArea, String bodyArea, 
			...
			String CalanderFrom, String CalanderTo)
	{
		body_sendDashboard_addRecipientsTo_recipientsTypeMenu = By.xpath("//span[contains(.,'"+ToEmailAddress+"')]"
				+ "//following-sibling::span//span[@class='recipient-menu']//button//i");
		body_sendDashboard_addRecipientsCc_recipientsTypeMenu = By.xpath("//span[contains(.,'"+CcEmailAddress+"')]"
...
//			ElementActions.select(driver, body_scheduleDashboard_everyPicker_recurrence, Recurrence);
//			ElementActions.typeAppend(driver, body_scheduleDashboard_everyPicker_recurrence, Recurrence);
...
//		ElementActions.typeAppend(driver, body_scheduleDashboard_datePicker_calanderFrom, CalanderFrom);
		}
		
		if(CalanderTo != null)
		{			ElementActions.click(driver, body_scheduleDashboard_datePicker_calanderTo);
		ElementActions.type(driver, selectDate, CalanderTo);
		}else {
			ElementActions.click(driver, body_scheduleDashboard_datePicker_doesNotEnd_checkbox);
		}
