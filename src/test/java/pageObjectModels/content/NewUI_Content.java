...
public class NewUI_Content {
	...
	//// Elements
	By header_contentHeader_link = By
			.xpath("//li[@class='inc-header-item']/a[contains(@href,'incorta/new')][normalize-space(.)='Content']");
	// By body_folder_link;
	...
	// By popup_newDashboard_create_button =
	// By.xpath("//button[@type='submit'][normalize-space()='Create']");
	// By popup_newFolder_folderName = By.xpath("//div[@class='inputGroup
	// newItemModal']/input");
	...
	// By popup_SchemaSettings_SharingTab_ClickSearchField =
	// By.xpath("//div[@class='shareSearch ng-scope']/input[@type=\"text\"]");
	// By popup_renameFolder;
	//
	// By popup_renameFolder_cancelButton =
	// By.xpath("//a[contains(string(),'Cancel')]");
	// By popup_rename_moveFolder_rename_done_move_Buttons =
	// By.xpath("//button[contains(string(),'Done')]");
	//
	// By popup_moveFolder_folderNameToMoveTo;
	// By popup_ManageDashboard_SharingTab_Permission;
	// By popup_ManageDashboard_SharingTab_SaveButton =
	// By.xpath("//button[contains(string(), 'Save')]");
	// By popup_ManageDashboard_SharingTab_UsersPermission;
	// By popup_ManageDashboard_Copy_FolderToCopyTo;
	// By popup_ManageDashboard_Copy_CopyButton =
	// By.xpath("//button[contains(text(),'Copy')]");
	// By popup_ManageDashboard_Move_MoveButton =
	// By.xpath("//button[contains(text(),'Move')]");
	// By popup_ManageDashboard_Rename_RenameButton =
	...
	public void selectDashboardMenuButton(String dashboard_name) {
		...
		// + "']//following-sibling::a[@class='menu-icon flex-box flex-align-center
	...
	public void Assert_dashboardIsDisplayed(String name) {
		// body_dashboard_link = By.xpath(" //section[@id=\"content\"]//a[@title='" +
		// name + "']");
	...
	public String setNewDashboardName() {
		return "";
		// String newDashboardName = "Automation" + "_Dashboard_" +
		// String.valueOf(System.currentTimeMillis());
		// ElementActions.type(driver, popup_newDashboard_dashboardName_textBox,
		// newDashboardName);
	...
	public String SetNewFolderName() {
		return "";
		// String newFolderName = "Automation" + "_Folder_" +
		// String.valueOf(System.currentTimeMillis());
	...
	public void Click_Folder_Dashboard_Properties(String FolderName) {
		// body_folderProperties_Button =
		// By.xpath("//a[@title='"+FolderName+"']/parent::div/a[contains(@class,'menu-icon')]");
	 ...
	 *            shareFolder moveFolder renameFolder deleteFolder
	 */
	public void Click_FolderProperties_ManageFolderButtons(String ActionsOnFolder) {
		// popup_folderProperties_manageFolder =
		// By.xpath("//a[@class='"+ActionsOnFolder+"']");
	 ...
	 *            Delete [Confirm delete folder] Cancel [Cancel Confirmation for
	 *            delete folder]
	 */
	public void Click_Folder_Dashboard_Properties_ManageFolderButtons_ConfirmationButtonsForDelete(
			String ConfirmationButtonName) {
		// popup_folderProperties_manageFolder_confirmationButton =
		// By.xpath("//div[contains(@class,'DeleteModal')]//a[contains(string(),'"+ConfirmationButtonName+"')]");
		// ElementActions.click(driver,
		// popup_folderProperties_manageFolder_confirmationButton);
	}

	public void Folder_Sharing_SearchAndSelectUsers(String SearchText) {
		// popup_SchemaSettings_SharingTab_SelectFromSearchField =
		// By.xpath("//h5[@class='UserData left
		// ng-binding'][contains(text(),'"+SearchText+"')]");
		// ElementActions.type(driver, popup_SchemaSettings_SharingTab_ClickSearchField,
		// SearchText);
		// ElementActions.click(driver,
		// popup_SchemaSettings_SharingTab_SelectFromSearchField);
	}
	...
	public String FolderProperties_RenameFolder() {
		return "";
		// String newFolderName = "Automation" + "_Dashboard_" +
		// String.valueOf(System.currentTimeMillis());
	...
	public void FolderProperties_Rename_MoveFolder_Buttons(String ButtonName) {
		// popup_rename_moveFolder_rename_done_move_Buttons =
		// By.xpath("//button[contains(string(),'"+ButtonName+"')]");
		// ElementActions.click(driver,
		// popup_rename_moveFolder_rename_done_move_Buttons);
	}

	public void Click_FolderProperties_MoveFolder_FolderNameToMoveTo(String FolderName) {
		// popup_moveFolder_folderNameToMoveTo =
		// By.xpath("//p[contains(string(),'"+FolderName+"')]");
	...
	/**
	 * @param Actions
	 *            Delete Rename Copy Share Export Move
	 */
	public void Click_DashboardProperties_ManageDashboardButtons(String Actions) {
		// Delete Dashboard
		// Used this variable ActionsOnFolder --> To avoid duplications between 2
		// buttons [Delete and export].

		// body_dashboardProperties_Button =
		// By.xpath("//div[contains(@class,'folderSettingsModal')]//a[contains(string(),'"+Actions+"')]");
	...
	public void Dashboard_Sharing_ClickOnUserPermission(String UserPermission) {
		// popup_ManageDashboard_SharingTab_Permission =
		// By.xpath("//h5[contains(string(), '"+UserPermission+"')]");
	...
	public void Assertion_Sharing_UserPermission(String SharedWithUser, String Permission) {
		...
		// By.xpath("//h5[@class='left
		// ng-binding'][contains(string(),'"+SharedWithUser+"')]"
		// +
		// "//parent::div//following-sibling::div/a[contains(string(),'"+Permission+"')]/parent::div");
		// Assertions.assertElementExists(driver,
		// popup_ManageDashboard_SharingTab_UsersPermission, true);
	}

	public void Dashboard_popup_ClickOnFolder(String FolderName) {
		// popup_ManageDashboard_Copy_FolderToCopyTo =
		// By.xpath("//a[@ng-click='openFolder(folder)']/span[@name='"+FolderName+"']/parent::a");
