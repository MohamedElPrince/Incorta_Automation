...
public class NewUI_Header {
    ...
    //// Elements
    // first menu
    By navigationWrapper_incortaLogo_image = By.xpath("//div[@class='nav-wrapper']//img[contains(@src,'incorta-white-logo')]");
    ...
    By navigationWrapper_userMenu_about_button = By.xpath("//div[@class='nav-wrapper']//span[text()='About']//ancestor::button");
    By navigationWrapper_userMenu_signOut_button = By.xpath("//div[@class='nav-wrapper']//span[text()='Sign Out']//ancestor::button");
	...
	List<String> sectionNames = Arrays.asList("Content", "Scheduler", "Business Schema", "Schema", "Data", "Security");

	sectionNames.forEach((sectionName) -> {
	    navigationWrapper_sectionHeader_link = By.xpath("//li[@class='inc-header-item']/a[normalize-space(.)='" + sectionName + "']");
