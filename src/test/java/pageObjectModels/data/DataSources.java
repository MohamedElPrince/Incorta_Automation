...
public class DataSources {
    ...
    private String url = System.getProperty("incortaRoot") + testDataReader.getCellData("URL_data_dataSources");

    //// Elements
    private By header_dataSourcesTabHeader_link = By
	    .xpath("//*[@id='content']//div[contains(@class,'secHeaderTitle')]//a[normalize-space(.)='Data Sources']");

    private By body_name_link;

    private By popup_addNewDatasource_dataSource_list = By
	    .xpath("//select[@ng-model='$parent.dataSource.properties.database']");
    private By popup_addNewDatasource_dataSourceName_textBox = By.xpath("//input[@ng-model='$parent.dataSource.name']");
    private By popup_addNewDatasource_username_textBox = By
	    .xpath("//input[@ng-model='$parent.dataSource.properties[property.name]'][@name='user']");
    private By popup_addNewDatasource_password_textBox = By
	    .xpath("//input[@ng-model='$parent.dataSource.properties[property.name]'][@name='password']");
    private By popup_addNewDatasource_connectionPool_textBox = By
	    .xpath("//input[@placeholder='Connection Pool'][@inputmode='numeric']");
    private By popup_addNewDatasource_connectionString_textBox = By
	    .xpath("//textarea[@ng-model='$parent.dataSource.properties[property.name]'][@name='connection']");
    private By popup_addNewDatasource_addDataSource_button = By
	    .xpath("//button[@ng-click='updateDataSource(dataSource, dataSourceForm)']");
    private By popup_newDataSource_done_button = By.xpath("//button[@ng-click='modal.closeMe()']");

    private By popup_newDataSource_headerName_label = By.xpath("//span[@ng-if='!newDataSource']");
