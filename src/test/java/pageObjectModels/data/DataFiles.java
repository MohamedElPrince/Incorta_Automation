...
public class DataFiles {
    ...
    private String url = System.getProperty("incortaRoot") + testDataReader.getCellData("URL_data_dataFiles");
    private String dataFilesFolderPath = System.getProperty("testDataFolderPath") + "dataFiles/";

    //// Elements
    private By header_dataFilesTabHeader_link = By
    ...
    private By popup_uploadNewDataFile_selectFromYourPC_textBox = By
	    .xpath("//div[contains(@class,'folderActions')]//input[@type='file']");
    private By popup_uploadNewDataFile_uploadSuccessMessage_label = By
	    .xpath("//div[contains(@class,'folderActions')]//p[@class='uploadSuccess']");
    private By popup_uploadNewDataFile_ok_button = By
