...
public class SchemaLoads {
    ...
    private String url = System.getProperty("incortaRoot") + testDataReader.getCellData("URL_scheduler_schemas");

    //// Elements
    private By header_schemasTabHeader_link = By
    ...
    private By body_Job_status_label;
    private By body_schemajobName_link;
    private By body_jobStatus_state;
    private By body_iframe = By.xpath("//iframe[@title='Legacy Web']");

    private By popup_scheduleSchema_repeat_radioButton;
    private By popup_scheduleSchema_weeklyDay_checkBox;
    private By popup_scheduleSchema_loadType_dropDownMenu;
    private By popup_scheduleSchema_confirmChangingStatusOk_button;
    private By popup_scheduleSchema_saveChanges_button = By
	    .xpath("//button[@type='button'][contains(text(),'Save Changes')]");
    private By popup_scheduleSchema_dailyRecurrence_Type;
    private By popup_scheduleSchema_dailyRecurrence_day_hour = By
	    .xpath("//div[@ng-switch-when='Daily']//input[@type='number']/following-sibling::input");
    private By popup_scheduleSchema_dailyRecurrence_number;

    // Confirm Delete popup view
    private By popup_scheduleSchema_delete_button = By
	    .xpath("//button[@ng-click='confirmDeleteScheduler();'][contains(text(),'Delete')]");

    // private By body_nextRun_label;

    private By popup_scheduleSchemaLoad_jobName_textBox = By
	    .xpath("//ng-form[@name='$ctrl.scheduleForm']//input[@name='jobName']");
    private By popup_scheduleSchemaLoad_description_textBox = By
	    .xpath("//ng-form[@name='$ctrl.scheduleForm']//input[@name='description']");
    private By popup_scheduleSchemaLoad_schema_list = By
	    .xpath("//ng-form[@name='$ctrl.scheduleForm']//select[@name='schemaName']");
    private By popup_scheduleSchemaLoad_loadType_list = By
	    .xpath("//ng-form[@name='$ctrl.scheduleForm']//select[@name='loadType']");
    private By popup_scheduleSchemaLoad_startByDate_textBox = By.xpath(
	    "//ng-form[@name='$ctrl.scheduleForm']//input[@ng-model='$ctrl.jobObject.startTime']/following-sibling::input[1]");
    private By popup_scheduleSchemaLoad_startByTime_textBox = By.xpath(
	    "//ng-form[@name='$ctrl.scheduleForm']//input[@ng-model='$ctrl.jobObject.startTime2']/following-sibling::input[1]");
    private By popup_scheduleSchemaLoad_startByTimeZone_textBox = By
	    .xpath("//ng-form[@name='$ctrl.scheduleForm']//select[@ng-model='$ctrl.jobObject.timezone']");
    private By popup_scheduleSchemaLoad_recurrenceFrequency_radioButton; // ng-form[@name='$ctrl.scheduleForm']//parent::label[normalize-space()='Daily']/input[@type='radio']
    private By popup_scheduleSchemaLoad_schedule_button = By
	...
	popup_scheduleSchema_dailyRecurrence_number = By.xpath(
