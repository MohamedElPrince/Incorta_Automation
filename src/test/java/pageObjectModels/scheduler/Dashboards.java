...
public class Dashboards {
    ...
    private String url = System.getProperty("incortaRoot") + testDataReader.getCellData("URL_scheduler_dashboards");

    //// Elements
    private By header_dashboardsTabHeader_link = By
	    .xpath("//*[@id='content']//div[contains(@class,'secHeaderTitle')]//a[normalize-space(.)='Dashboards']");
    private By body_jobStatus_list = By.xpath("//select[@ng-change='jobStatusChanged()']");
    // private By body_name_link;
    private By body_dashboard_link;
    private By body_Status_label;
    // private By body_nextRun_label;
    private By body_name_link;
    private By body_checkBox_scheduleDashboard;
    private By Body_StatusFilter = By.name("displayedJobStatus");
    private By body_StatusFilter_Options;
    private By body_Status;
    private By body_CompletedStatus;
    private By body_ActiveStatus;

    private By body_iframe = By.xpath("//iframe[@title='Legacy Web']");
    private By body_JobName;
    private By body_Last_JobName = By.xpath(
    ...
    private By popup_JobScreen_RemoveEmail_Button;
    private By popup_JobScreen_SaveChanges_Button = By.xpath("//button[contains(text(),'Save Changes')]");
    private By popup_JobScreen_Email;
    private By popup_JobScreen_emailAddress_textBox = By.xpath("//input[@ng-model='$ctrl.entitySearchText']");
    private By popup_JobScreen_EmailAddress_add_button = By.xpath("//button[@type='button'][normalize-space()='Add']");
    private By popup_JobScreen_SubjectField = By.name("subject");
    private By popup_JobScreen_BodyField = By
	    .xpath("//label[contains(text(),'Body')]/parent::div/following-sibling::textarea[@name='description']");
    private By popup_JobScreen_EmailPlusButton;
    private By popup_JobScreen_JobNameField = By.xpath("//ng-form[@name='$ctrl.scheduleForm']//input[@name='jobName']");
    private By popup_JobScreen_description_textBox = By
	    .xpath("//ng-form[@name='$ctrl.scheduleForm']//input[@name='description']");
    private By popup_JobScreen_startByDate_textBox = By.xpath(
	    "//ng-form[@name='$ctrl.scheduleForm']//input[@ng-model='$ctrl.jobObject.startTime']/following-sibling::input[1]");
    private By popup_JobScreen_startByTime_textBox = By.xpath(
	    "//ng-form[@name='$ctrl.scheduleForm']//input[@ng-model='$ctrl.jobObject.startTime2']/following-sibling::input[1]");
    private By popup_JobScreen_startByTimeZone_textBox = By
	    .xpath("//ng-form[@name='$ctrl.scheduleForm']//select[@ng-model='$ctrl.jobObject.timezone']");
    private By popup_JobScreen_recurrenceFrequency_radioButton;
    private By popup_jobScreen_selectOutputFormat;
    private By popup_JobScreen_dailyRecurrence_number = By.xpath("//div[@ng-switch-when='Daily']//input[@type='text']");
    private By popup_jobScreen_weeklyRecurrence_days;

    private By popup_jobScreen_monthleyRecurrence_Type_radioButton;
    private By popup_jobScreen_monthleyRecurrence_Type_DayNumber = By.xpath("//select[@name='nth']");
    private By popup_jobScreen_monthleyRecurrence_Type_DayOfWeek = By
	    .xpath("//select[contains(@ng-model,'dayOfWeek')]");
    private By popup_jobScreen_monthleyRecurrence_Type_DayOfMonth = By
	    .xpath("(//input[@type='radio'][@value='Week']/parent::div/input)[last()]");
    private By popup_jobScreen_repeat_noEnd = By.xpath("//input[@value='0']");
    private By popup_jobScreen_EndBy = By.xpath("//div[@class='flex-box']/label[contains(string(),'End By')]/input");
    private By popup_jobScreen_EndBy_Date = By.xpath("//div[@class='flex-box']//input[contains(@class,'ws-date')]");

    private By body_nextRun;

    private By popup_confirmation_Delete_Cancel_ScheduleDashboard;
    private By popup_confirmation_Suspend_ScheduleDashboard;
    private By popup_sendDashboard_label_hideNotificationText_checkbox = By.xpath(
	    "//label[contains(text(),'Hide Notification Text')]/following-sibling::input[contains(@class,'checkbox')]");

    private By popup_sendDashboard_FileNameField = By.name("fileName");
    private By popup_sendDashboard_label_AppendTimestamp_checkbox_empty = By.xpath(
	    "//label[contains(text(),'Append Timestamp')]/following-sibling::input[contains(@class,'checkbox')]");

    private By popup_JobScreen_label_hideNotificationText_checkbox_empty = By.xpath(
	    "//label[contains(text(),'Hide Notification Text')]/following-sibling::input[contains(@class,'checkbox')]");

    private By popup_JobScreen_label_AppendTimestamp_checkbox = By.xpath(
	    "//label[contains(text(),'Append Timestamp')]/following-sibling::input[contains(@class,'checkbox')]");

    private By popup_jobScreen_dailyRecurrence_Type;

    private By popup_scheduleDashboard_recurrenceFrequency_radioButton;
	...
	ElementActions.switchToIframe(driver, body_iframe);
	body_Status_label = By.xpath("//div[contains(@class,'userName')][contains(normalize-space(.)," + "'" + name
		+ "')]/following-sibling::div[contains(@class,'dataConnectionLink')][contains(.,'" + expectedStatus
		+ "')]");
