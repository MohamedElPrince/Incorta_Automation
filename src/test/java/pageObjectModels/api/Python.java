...
public class Python {
    //// Variables
    private String incortaURL, tenantName, superUser, superPass;
    private boolean verifyCertificate;

    private String pathToBinFolder, pathToAutomationShellScript;
    private String automationBaseScriptFile = "Automation_Base.sh";
    private CLI instance;

    private String pathToAutomationOutputFolder;
    private String automationOutputFileName;
